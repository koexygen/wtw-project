...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./src/css/style.scss":
/*!*********************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/dist/cjs.js!./src/css/style.scss ***!
  \*********************************************************************************************/
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader!../../node_modules/sass-loader/dist/cjs.js!./style.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/dist/cjs.js!./src/css/style.scss");
...
/* harmony import */ var _network__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./network */ "./src/js/network.js");
...
function animate() {
  ...
  c.fillText("Gio's WTW", mouse.x + 10, mouse.y + 10); // objects.forEach(object => {
  //  object.update()
  // })
}
...
var reworkData = function reworkData() {
  var imgURL = "https://image.tmdb.org/t/p/w500";
  searchResult.map(function (movie, idx) {
...
var linksFrom = function linksFrom(movie) {
  return searchResult.map(function (arrMovie) {
...
function draw() {
  ...
  nodes = searchResult;
  edges = linksFrom(searchResult[0]); // create a network
  ...
  network = new vis_network__WEBPACK_IMPORTED_MODULE_0__["Network"](container, data, options);
  console.log(network);
...
var requestTimer;
var listenInput = _search__WEBPACK_IMPORTED_MODULE_1__["input"].addEventListener("input", function (e) {
  clearTimeout(requestTimer);
  requestTimer = setTimeout(function () {
    _search__WEBPACK_IMPORTED_MODULE_1__["searchMovie"](e.target.value).then(function (data) {
